...
-   `close_up` - This function accepts a pandas dataframe object and the number of pairs of strongest correlations. It creates scatterplots with a linear trend for each pair of variables with stronglest correlations. 
